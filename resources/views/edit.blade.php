@extends('welcome')
@section('cards')
<form  action="/blah/{{$book['id']}}" class="container" method="POST" enctype="multipart/form-data">
    ...
    <!-- Password input -->
    <div class="form-outline mb-1">
      <input name="author" type="text" id="form1Example2" class="form-control" value="{{$book['author']}}" />
...
<div class="form-outline mb-1 ">
  <input name="imageLink" type="file" id="form1Example2" class="form-control" value="{{$book['imageLink']}}" />
  <label class="form-label" for="form1Example2">Year</label>
</div>
@error('imageLink')
<small class="text-danger ">{{$message}}</small>
