                        ...
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            @auth
                                ...
                                @if (auth()->user()->role == 'author')
                                    <li class="nav-item">
                                        <a class="nav-link" href="/auth-index">My Desk</a>
                                    </li>
                                @endif
                                @if (auth()->user()->role == 'user')
                                    <li class="nav-item">
                                        <a class="nav-link" href="/become-author">Become an author</a>
                                    </li>
                                @endif
                                <li class="nav-item">
                                    <form method="POST" action="/logout">
                                        @csrf
                                        <button type="submit" class="btn btn-danger btn-sm mt-2 ms-2 ">Logout <i
                                                class="fas fa-door-open fa-1x ms-1  " style="color: #7999cd"></i></button>
                                    </form>
                                </li>
                            @else
                                <li class="nav-item ">
